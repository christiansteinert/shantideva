...
var LANG=[];
var LANG_FONTS = 
    '<p>The source code of this app is available at: <a href="https://github.com/christiansteinert/shantideva/" target="_blank" onclick="window.open(\'https://github.com/christiansteinert/shantideva/\',\'_system\',\'location=no\');return false;">https://github.com/&#x200b;christiansteinert/&#x200b;shantideva/</a>.</p>'
    +'<hr />'
    +'<p>For Tibetan this app uses the amazing <strong>DDC Uchen</strong> font developed by the outstanding Chris Fynn available from <a href="https://sites.google.com/view/chrisfynn/home/fonts/ddc-uchen" target="_blank" onclick="window.open(\'https://sites.google.com/view/chrisfynn/home/fonts/ddc-uchen\',\'_system\',\'location=no\');return false;">https://sites.google.com/&#x200b;view/chrisfynn/&#x200b;home/fonts/&#x200b;ddc-uchen</a>.'
    +'<p>For headings this app uses the wonderfully beautiful Font <strong>Tangerine Bold</strong> by Tashi Omagari, available from <a href="http://www.google.com/fonts/specimen/Tangerine" target="_blank" onclick="window.open(\'http://www.google.com/fonts/specimen/Tangerine\',\'_system\',\'location=no\');return false;">http://www.google.com/&#x200b;fonts/&#x200b;specimen/&#x200b;Tangerine</a>.</p><p>Many thanks go to the developers of these fantastic fonts.</p><p>These fonts font are used under the following terms:</p>'
...
var LANG_TRANSLATIONS = '<p><ul style="text-align:left;"><li>English translation: Dr. Alexander Berzin (translation from Tibetan, clarified on the basis of the Sanskrit version). studybuddhism.com</li>'
    ...
    +'<a href="https://www.putishuyuan.com" target="_blank" onclick="window.open(\'https://www.putishuyuan.com\',\'_system\',\'location=no\');return false;">www.putishuyuan.com</a>, '
    +'<a href="https://www.bodhiacademy.org" target="_blank" onclick="window.open(\'https://www.bodhiacademy.org\',\'_system\',\'location=no\');return false;">www.bodhiacademy.org</a>'
    +'</li>'
    ...
    +'<a href="https://indica-et-buddhica.org" target="_blank" onclick="window.open(\'https://indica-et-buddhica.org\',\'_system\',\'location=no\');return false;">indica-et-buddhica.org</a>, '
    +'</li>'
    +'</ul></p>';
...
LOGO='<p><img src="content/info-logo.png" style="max-width:90%" width="350" /><br/><a href="https://www.shantideva.com/" target="_blank" onclick="window.open(\'https://www.shantideva.com\',\'_system\',\'location=no\');return false;"><strong>www.shantideva.com</strong></a></p><hr />';
...
LANG_ABOUT_RU = 'Приложение каждый день показывает по одной строфе из текста Шантидевы «Вступая на путь поведения бодхисаттвы» («Бохисаттва-чарья-аватара»), а также в нём можно прочитать весь текст. «Вступая на путь поведения бодхисаттвы» – крайне практичный и вдохновляющий буддийский текст, в котором рассматриваются все аспекты буддийского пути. Шантидева был выдающимся индийским буддийским мастером 8-го века. Сохранились два его текста – «Бодхичарья-аватара», которому посвящено это приложение, и «Шикша-самуччая» («Собрание практик»). Оба текста по-прежнему широко используются, особенно «Бодхичарья-аватара», ставший одним из самых ценных и часто преподаваемых текстов тибетской традиции.'
    ...
    +'<a href="https://studybuddhism.com/ru/tibetskiy-buddizm/klassicheskie-teksty/teksty-sutry/vstupaya-na-put-povedeniya-bodhisattvy" target="_blank" onclick="window.open(\'https://studybuddhism.com/ru/tibetskiy-buddizm/klassicheskie-teksty/teksty-sutry/vstupaya-na-put-povedeniya-bodhisattvy\',\'_system\',\'location=no\');return false;">'
    +'этот текст'
    +'</a> '
    +'и много других материалов о буддизме на множестве языков на сайте: '
    +'<a href="https://studybuddhism.com/ru" target="_blank" onclick="window.open(\'https://studybuddhism.com/ru\',\'_system\',\'location=no\');return false;">'
    +'studybuddhism.com'
    +'</a></strong></p>'
    +'<p lang="ru" class="ru">'
...
LANG_ABOUT_ES = 'Esta App muestra un verso cada día del texto de Shantideva “Involucrarse en el comportamiento del bodisatva” (Bodhisattvacharyavatara) y permite la lectura del texto completo. “Involucrarse en el comportamiento del bodisatva” es un texto budista increíblemente práctico e inspirador que cubre todos los aspectos del camino budista. Shantideva fue un gran maestro budista indio que vivió durante el siglo VIII e. c. Sobreviven dos de sus textos: el Bodhicharyavatara (el texto que se muestra en esta app) y el Shikshasamuccaya (“Compendio de entrenamientos”). Ambos textos han seguido en uso hasta el presente, en especial el Bochicharyavatara, que es uno de los textos de la tradición tibetana más atesorados y más frecuentemente usados en las enseñanzas.'
    ...
    +'<a href="https://studybuddhism.com/en/tibetan-buddhism/original-texts/sutra-texts/engaging-in-bodhisattva-behavior" target="_blank" onclick="window.open(\'https://studybuddhism.com/en/tibetan-buddhism/original-texts/sutra-texts/engaging-in-bodhisattva-behavior\',\'_system\',\'location=no\');return false;">'
    +'este texto'
    +'</a> '
    +'y muchos más materiales budistas en diversos idiomas en:: '
    +'<a href="https://studybuddhism.com/es" target="_blank" onclick="window.open(\'https://studybuddhism.com/es\',\'_system\',\'location=no\');return false;">'
    +'studybuddhism.com'
    +'</a></strong></p>'
    +'<p lang="es" class="es">'
...
LANG_ABOUT_AR = '<span dir="rtl" class="ar" lang="ar">هذا التطبيق يعرض بيتًا واحدًا في اليوم من نَص شانتيديفا "الانخراط في سلوك البوديساتفا" (بوديساتفاتشارياأفاتارا) ويُتيح لكم قراءة النَّص بأكمله. نص "الانخراط في سلوك البوديساتفا" هو نص بوذي عملي وملهم بشكل استثنائي، يُغطي جميع جوانب المسار البوذي. كان شانتيديفا معلمًا بوذيًا هنديًا عظيمًا، عاش خلال القرن الثامن الميلادي. نَصان له نجيا – البوديساتفاتشارياأفاتارا (النَّص المعروض في هذا التطبيق) ونَص الشيكشاساموكايا ("مُلخَّص التدريبات"). كلا النَّصين ما يزالا يُستخدمان حتى يومنا هذا، وخاصة البوديساتفاتشارياأفاتارا الذي يُعَد واحد من أكثر النصوص الذي يُعتَزّ بها ويتم تدريسها في التقليد التبتي.'
    ...
    +'<a href="https://studybuddhism.com/ar/albwdhyt-altbtyt/alnsws-alaslyt/nsws-alswtra/alankhrat-fy-slwk-albwdysatfa" target="_blank" onclick="window.open(\'https://studybuddhism.com/ar/albwdhyt-altbtyt/alnsws-alaslyt/nsws-alswtra/alankhrat-fy-slwk-albwdysatfa\',\'_system\',\'location=no\');return false;">'
    +'</a>.'
    +'</strong></p>'
...
LANG['de']={
    ...
    +'</p>'
    +'<p lang="de" class="de"><strong><a href="https://studybuddhism.com/de/tibetischer-buddhismus/originaltexte/sutra-texte/eintritt-in-das-verhalten-eines-bodhisattvas/die-vorzuege-des-erleuchtungsgeistes" target="_blank" onclick="window.open(\'https://studybuddhism.com/de/tibetischer-buddhismus/originaltexte/sutra-texte/eintritt-in-das-verhalten-eines-bodhisattvas/die-vorzuege-des-erleuchtungsgeistes\',\'_system\',\'location=no\');return false;">Dieser Text</a> und umfangreichere weitere Materialien sind in zahlreichen Sprachen auf <a href="https://studybuddhism.com/de" target="_blank" onclick="window.open(\'https://studybuddhism.com/de\',\'_system\',\'location=no\');return false;">studybuddhism.com</a> verfügbar.</strong></p>'
...
LANG_ABOUT_BO= 'བཀོལ་སྤྱོད་མཉེན་ཆས་འདིས་སློབ་དཔོན་ཆེན་པོ་ཞི་བ་ལྷས་མཛད་པའི་ “བྱང་ཆུབ་སེམས་དཔའི་སྤྱོད་པ་ལ་འཇུག་པ་”ཞེས་པའི་གཞུང་ནས་ཉིན་རེ་བཞིན་ཚིགས་སུ་བཅད་པ་གཅིག་སྟོན་པའི་སྒོ་ནས་གཞུང་ཆ་ཚང་བ་ཀློག་ཏུ་འཇུག་གི་ཡོད། སྤྱོད་འཇུག་ལྟ་བུར་མཚོན་ན། ཁྱད་པར་དུ་འཕགས་ཤིང་ཁ་ཡོད་ལག་ཡོད་ཀྱི་ཉམས་ལེན་དང་བློ་སྤོབས་སྤེལ་བའི་ནང་པའི་ལམ་གྱི་རིམ་པའི་ཁྱད་རྣམ་ཆ་ཚང་བའི་གཞུང་ལུགས་ཤིག་ཡིན་པ་རེད། ཞི་བ་ལྷ་ནི་རྒྱ་གར་གྱི་སློབ་དཔོན་ཆེན་པོ་ཞིག་ཡིན་པ་དང་ཁོང་དུས་རབས་ ༨ པའི་ནང་བྱོན། ད་ལྟ་ང་ཚོས་མཇལ་རྒྱུ་ཡོད་པའི་ཁོང་གི་གཞུང་ལུགས་གཉིས་ཏེ། བཀོལ་སྤྱོད་མཉེན་ཆས་འདིའི་ནང་བསྟན་པའི་སྤྱོད་འཇུག་དང་བསླབ་པ་ཀུན་ལས་བཏུས་པ་རེད། གཞུང་དེ་གཉིས་ཀ་ད་ལྟའང་སློབ་གཉེར་བྱེད་ཀྱི་ཡོད་པ་དང་དམིགས་བསལ་སྤྱོད་འཇུག་ནི་བོད་ཀྱི་སྲོལ་རྒྱུན་གྱི་ནང་གཙིགས་ཆེ་ཤོས་བརྩི་བ་དང་ཡང་ནས་ཡང་དུ་སློབ་འཁྲིད་བྱས་དང་བྱེད་མུས་ཀྱི་གཞུང་ལུགས་ནང་གི་གཅིག་ཆགས་ཀྱི་ཡོད།'
    ...
    +'<a href="https://studybuddhism.com/bo/bod-kyi-nang-chos/ma-dpe-khag/mdo-i-dpe-cha/byang-chub-sems-dp-i-spyod-pa-la-jug-pa" target="_blank" onclick="window.open(\'https://studybuddhism.com/bo/bod-kyi-nang-chos/ma-dpe-khag/mdo-i-dpe-cha/byang-chub-sems-dp-i-spyod-pa-la-jug-pa\',\'_system\',\'location=no\');return false;">'
